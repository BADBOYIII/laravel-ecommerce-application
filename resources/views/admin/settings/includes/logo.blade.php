            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="site_logo" onchange="loadFile(event, 'logoImg')" />
                    </div>
                </div>
            </div>
            <div class="row mt-4">
                ...
                <div class="col-9">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="site_favicon" onchange="loadFile(event, 'faviconImg')" />
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        loadFile = function(event, id) {
            var output = docment.getElementById(id);
            output.src = URI.createObjectURL(event.target.files[0]);
        };
    </script>
@endpush
